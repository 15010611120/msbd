...
public class Page {
	  ...
	  private Integer[] arrPageSize = { Integer.valueOf(5), Integer.valueOf(10), Integer.valueOf(15), Integer.valueOf(20), Integer.valueOf(25), Integer.valueOf(30), Integer.valueOf(50), Integer.valueOf(100), Integer.valueOf(200), Integer.valueOf(500) };
	  ...
	  public void initPageList()
	  {
	    if (this.arrPageSize.length == 0)
	      this.arrPageSize = new Integer[] { Integer.valueOf(5), Integer.valueOf(10), Integer.valueOf(15), Integer.valueOf(20), Integer.valueOf(25), Integer.valueOf(30), Integer.valueOf(50), Integer.valueOf(100) };
	  }
	  ...
	  private StringBuffer createPageSizeList()
	  {
	    ...
	    for (int i = 0; i < this.arrPageSize.length; i++) {
	      if (this.pageSize == this.arrPageSize[i].intValue())
	        s.append("<option value=" + this.arrPageSize[i] + " selected=\"selected\">" + this.arrPageSize[i] + "</option>");
	      else {
